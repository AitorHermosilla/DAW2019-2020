/*
9. El usuario nos va a proporcionar a traves del teclado el n ´ umero de ´
...
(hay que comprobar que es valido) y el n ´ umero de unidades vendidas ´
de ese producto. Al final del d´ıa, es decir, cuando el usuario nos
